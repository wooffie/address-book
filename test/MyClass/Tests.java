...
public class Tests {
    ...
    public void findPersons(){
        ...
        assertEquals(Arrays.asList("Овсянников", "Алтухов", "Кришталь"),book.findPersons("Науки"));
        assertEquals(Collections.emptyList(),book.findPersons("Бутлерова"));
        assertNotEquals(Arrays.asList("Овсянников", "Алтухов", "Кришталь"),book.findPersons("Науки",47));
        assertEquals(Arrays.asList("Овсянников", "Кришталь"),book.findPersons("Науки",47));
